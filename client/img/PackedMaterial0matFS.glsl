...
uniform vec3 unf18;
const float cons21 = float(1.000000000000);
uniform sampler2D samp1;
varying vec4 var1;
const float cons34 = float(0.000000000000);
uniform sampler2D samp2;
uniform float unf46;
const float cons47 = float(1.000000000000);
const float cons49 = float(1.000000000000);
uniform sampler2D samp3;
uniform vec3 unf65;
const float cons68 = float(1.000000000000);
uniform sampler2D samp4;
uniform float unf78;
const float cons81 = float(1.000000000000);
const float cons83 = float(1.000000000000);
uniform mat4 light0_transform;
uniform float unf94;
uniform float unf104;
uniform float unf106;
uniform vec3 unf107;
const float cons112 = float(1.000000000000);
const vec4 cons116 = vec4(1.000000000000, 1.000000000000, 1.000000000000, 0.004999999888);
uniform float unf130;
const float cons146 = float(1.000000000000);
uniform vec4 unf147;
const float cons150 = float(1.000000000000);
uniform vec3 unf153;
...
void main()
{
	vec3 unf90 = light0_transform[3].xyz;
	...
	texco_uv(var0, tmp7);
	mtex_image(tmp7, samp0, tmp10, tmp11);
	set_rgba(tmp11, tmp13);
	mtex_alpha_from_col(tmp11, tmp15);
	srgb_to_linearrgb(tmp13, tmp17);
	mtex_rgb_mul(unf18, tmp17.rgb, tmp15, cons21, tmp22);
	texco_uv(var0, tmp24);
	mtex_normal(tmp24, samp1, tmp27);
	vec_math_negate(facingnormal, tmp29);
	mtex_nspace_tangent(var1, tmp29, tmp27, tmp33);
	mtex_blend_normal(cons34, tmp3, tmp33, tmp37);
	texco_uv(var0, tmp39);
	mtex_image(tmp39, samp2, tmp42, tmp43);
	mtex_alpha_from_col(tmp43, tmp45);
	mtex_value_blend(unf46, cons47, tmp45, cons49, tmp50);
	mtex_value_clamp(tmp50, tmp52);
	texco_uv(var0, tmp54);
	mtex_image(tmp54, samp3, tmp57, tmp58);
	set_rgba(tmp58, tmp60);
	mtex_alpha_from_col(tmp58, tmp62);
	srgb_to_linearrgb(tmp60, tmp64);
	mtex_rgb_mul(unf65, tmp64.rgb, tmp62, cons68, tmp69);
	texco_uv(var0, tmp71);
	mtex_image(tmp71, samp4, tmp74, tmp75);
	mtex_alpha_from_col(tmp75, tmp77);
	mtex_har_divide(unf78, tmp79);
	mtex_value_blend(tmp79, cons81, tmp77, cons83, tmp84);
	mtex_har_multiply_clamp(tmp84, tmp86);
	set_rgb_zero(tmp87);
	set_rgb_zero(tmp88);
	lamp_visibility_other(varposition, unf90, tmp91, tmp92, tmp93);
	lamp_falloff_invsquare(unf94, tmp92, tmp96);
	lamp_visibility_clamp(tmp96, tmp98);
	shade_inp(tmp37, tmp91, tmp101);
	shade_visifac(tmp101, tmp98, unf104, tmp105);
	shade_mul_value_v3(unf106, unf107, tmp108);
	shade_mul_value(tmp105, vec4(tmp108, 1.0), tmp111);
	mtex_value_invert(cons112, tmp113);
	mix_mult(tmp113, tmp111, cons116, tmp117);
	mtex_value_invert(tmp113, tmp119);
	shade_madd(vec4(tmp87, 1.0), tmp117, vec4(tmp22, 1.0), tmp123);
	shade_cooktorr_spec(tmp37, tmp91, tmp5, tmp86, tmp128);
	shade_spec_t(tmp119, unf130, tmp98, tmp128, tmp133);
	shade_add_spec(tmp133, tmp108, tmp69, tmp137);
	shade_add_clamped(vec4(tmp88, 1.0), vec4(tmp137, 1.0), tmp140);
	shade_clamp_positive(tmp140, tmp142);
	shade_clamp_positive(tmp123, tmp144);
	shade_maddf(tmp144, cons146, unf147, tmp148);
	alpha_spec_correction(tmp142.rgb, cons150, tmp52, tmp152);
	shade_add_mirror(unf153, tmp1, tmp148.rgb, tmp156);
	shade_add(vec4(tmp156, 1.0), tmp142, tmp159);
	mtex_alpha_to_col(tmp159, tmp152, tmp162);
